      ...
      <Box sx={{ display: 'flex' }}>
        ...
        <Container maxWidth="xl">
          <Typography variant="h5"
            sx={{ color: "rgb(42, 182, 131)", fontFamily: "Poppins, Roboto", fontSize: "30px", fontWeight: 700, textAlign: 'center' }}>
            Homepage
          </Typography>
          <Typography variant="h4"
            sx={{ color: "rgba(0, 0, 0, 0.6)", fontFamily: "Poppins, Roboto", fontWeight: 400, textAlign: 'center' }}>
            Welcome to DigiBuild Application
          </Typography>
        </Container>
