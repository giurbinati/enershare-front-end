...
GBXU.getSurfaceOpenings = function() {
	...
	const material = new LineBasicMaterial( { color: 0x444444, linewidth: 2, transparent: true } );
	const openingGroup = [];
