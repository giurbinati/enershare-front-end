...
import FIOEH from './fioeh-fix-interior-on-exterior-horizontal/fioeh-fix-interior-on-exterior-horizontal'
import CNH from './cnh-check-normals-horizontal/cnh-check-normals-horizontal'


export default class GF3 {}
...
GF3.setUp = function( text ) { // build a fresh menu any time a new file is loaded
	...
	//document.getElementById("FIOEHdivInteriorOnExteriorHorizontal").innerHTML = FIOEH.getMenuInteriorOnExteriorHorizontal();

	//document.getElementById("CNHdivCheckNormalsHorizontal").innerHTML = CNH.getMenuCheckNormalsHorizontal();
